...
class TimeMarchingCheckpoints(_Approach):
    from ozone.integrators.time_marching_uniform import TimeMarchingUniform
...
class PicardIteration(_Approach):
    from ozone.integrators.picard_iteration import PicardIteration
    integrator_class = PicardIteration
    name = 'Picard Iteration'

class Collocation(_Approach):
    from ozone.integrators.collocation import Collocation

from ozone_alpha.tests.run_ode import run_ode
from ozone_alpha.tests.test_correctness.test_1_simple.utils import (
    build_and_run_ode,
    check_derivs,
    check_output,
    get_settings_dict,
)
from ozone_alpha.approaches import PicardIteration, Collocation, TimeMarching, TimeMarchingCheckpoints
from ozone_alpha.methods import RK4, Trapezoidal
...
#     settings_dictionary = get_settings_dict()
#     settings_dictionary['approach'] = TimeMarchingCheckpoints()
#     settings_dictionary['system'] = 'CSDL'
#     settings_dictionary['num_method'] =  RK4()
#     checks = run_ode(settings_dictionary, build_and_run_ode)
#     check_output(checks['output'])

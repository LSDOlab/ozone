...
import ozone_alpha
from ozone_alpha.paper_examples.utils.utils import optimize_and_get_data, save_pickle
...
if __name__ == '__main__':
    ...
    # Get approach
    approaches = {
        'TimeMarching': ozone_alpha.approaches.TimeMarching,
        'TimeMarchingCheckpoints': ozone_alpha.approaches.TimeMarchingCheckpoints,
        'PicardIteration': ozone_alpha.approaches.PicardIteration,
        'Collocation': ozone_alpha.approaches.Collocation
    }

    # Get example
    from ozone_alpha.paper_examples.pde_control.pde_control import get_model_pde_control
    from ozone_alpha.paper_examples.trajectory_optimization.trajectory_optimization import get_model_trajectory_optimization
    from ozone_alpha.paper_examples.ascent_system.ascent_system import get_model_ascent_system
    from ozone_alpha.paper_examples.van_der_pol.van_der_pol import get_model_van_der_pol
    ...
    # Run analysis:
    if approach == ozone_alpha.approaches.TimeMarchingCheckpoints:
